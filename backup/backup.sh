...
LLatest=`date`
Get_Data () {
git clone https://github.com/sallxd/user-backup-db.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    ...
    git remote add origin https://github.com/sallxd/user-backup-db.git
    git push -f https://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@github.com/sallxd/user-backup-db.git &> /dev/null
}
...
link="https://raw.githubusercontent.com/sallxd/user-backup-db/main/$NameUser/$NameUser.zip"
sleep 1
